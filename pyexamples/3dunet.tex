...
\node[canvas is zy plane at x=0] (t1) at (-4.5,0,0) {\includegraphics[width=8cm,height=8cm]{../../t1.png}};

\node[canvas is zy plane at x=0] (t1ce) at (-4.0,0,0) {\includegraphics[width=8cm,height=8cm]{../../t1ce.png}};

\node[canvas is zy plane at x=0] (t2) at (-3.5,0,0) {\includegraphics[width=8cm,height=8cm]{../../t2.png}};

\node[canvas is zy plane at x=0] (flair-east) at (-3.0,0,0) {\includegraphics[width=8cm,height=8cm]{../../flair.png}};

\pic[shift={ (1,0,0) }] at (-east) 
    {RightBandedBox={
        name=ccr_b1,
        caption= ,
        xlabel={{ 32, 32 }},
        zlabel=(60$\times$60$\times$40),
        fill=\ConvColor,
...
\draw [connection]  (-east)    -- node {\midarrow} (ccr_b1-west);
