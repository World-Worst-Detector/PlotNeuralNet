...
# │    │    └─ExtResNetBlock: 3-7               [1, 512, 15, 15, 10]      17,697,280
    ...
    *block_Encoder("b4", "pool_b3", "ccr_res_b6", s_filer="(15$\\times$15$\\times$10)", n_filer=512, offset="(1,0,0)", size=(5,5,16), maxpool=False, opacity=0.5),
    
    #Decoder
    *block_2DeConv( name="b6", botton="ccr_b4", top='end_b6', s_filer="(30$\\times$30$\\times$20)",  n_filer=256, offset="(1,0,0)", size=(10,10,8), opacity=0.5 ),
    to_skip( of='ccr_b3', to='ccr_res_b6', pos_of=1.25),
    *block_2DeConv( name="b7", botton="end_b6", top='end_b7', s_filer="(60$\\times$60$\\times$40)", n_filer=128, offset="(2,0,0)", size=(20,20,4), opacity=0.5 ),
    to_skip( of='ccr_b2', to='ccr_res_b7', pos_of=1.25),
    *block_2DeConv( name="b8", botton="end_b7", top='end_b8', s_filer="(120$\\times$120$\\times$80)", n_filer=64, offset="(2.5,0,0)", size=(40,40,2), opacity=0.5 ),
    to_skip( of='ccr_b1', to='ccr_res_b8', pos_of=1.25),
